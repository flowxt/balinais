              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {status.success && (
                  <div className="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-lg text-sm">
                    Merci pour votre message ! Nous vous recontacterons dans les meilleurs délais.
                  </div>
                )}
                ...
                <button
                  ...
                  className="w-full bg-charcoal text-soft px-8 py-4 rounded-lg font-medium hover:bg-rustic transition-colors duration-300 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {status.loading ? (
                    <>
