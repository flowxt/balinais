        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="flex gap-4 pt-2">
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-white/5 hover:bg-warm/20 border border-white/10 hover:border-warm/30 flex items-center justify-center transition-all duration-300 group"
                aria-label="Instagram"
              >
                <svg className="w-4 h-4 text-soft/60 group-hover:text-warm transition-colors" fill="currentColor" viewBox="0 0 24 24">
