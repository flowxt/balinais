...
export default function APropos() {
  return (
    <>
      ...
      <section className="relative py-24 lg:py-32 bg-rustic overflow-hidden">
        {/* Motifs décoratifs */}
        <div className="absolute inset-0">
          <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-warm/10 rounded-full blur-3xl translate-x-1/2 -translate-y-1/2"></div>
          <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-creamy/10 rounded-full blur-3xl -translate-x-1/2 translate-y-1/2"></div>
        </div>
        
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center">
            <span className="inline-block text-soft/80 text-sm font-medium tracking-[0.3em] uppercase mb-6">
              Notre histoire
            </span>
            ...
            <p className="text-xl text-soft/80 max-w-2xl mx-auto leading-relaxed font-light">
